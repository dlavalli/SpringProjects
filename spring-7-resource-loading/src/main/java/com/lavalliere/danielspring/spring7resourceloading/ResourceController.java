...
public class ResourceController {
    ...
    public String getClasspathResource2() throws IOException {
        Resource resource = new ClassPathResource("myFile.txt");  // This imply it is on the classpath. ie: src/main/resources
    ...
    public String getUrlResource() throws IOException {
        return new String(urlResource.getContentAsByteArray(), StandardCharsets.UTF_8);  // Uses http:// | https:// to determine a URL
    }
