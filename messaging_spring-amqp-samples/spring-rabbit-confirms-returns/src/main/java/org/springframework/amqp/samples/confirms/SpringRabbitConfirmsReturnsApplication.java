...
public class SpringRabbitConfirmsReturnsApplication {
	...
	private void runDemo() throws Exception {
		...
		System.out.println("Return received:"  + correlationData.getReturned().getMessage());
	}
	...
	private void setupCallbacks() {
		...
		this.rabbitTemplate.setReturnsCallback(returnCallback -> {
			System.out.println("Returned: " + returnCallback.getMessage() + "\nreplyCode: " + returnCallback.getReplyCode()
					+ "\nreplyText: " + returnCallback.getReplyText() + "\nexchange/rk: " + returnCallback.getExchange() + "/" + returnCallback.getRoutingKey());
		});
	}
